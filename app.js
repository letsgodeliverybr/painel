...
function atualizarMarcadores(){
  ...
  const _svgPin=`<svg width="36" height="36" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,600) scale(0.066667,-0.066667)" fill="#1A56DB" stroke="none"><path d="M4305 7831 c-1340 -140 -2206 -1469 -1784 -2737 25 -73 94 -235 155 -360 1889 -3889 1726 -3571 1822 -3571 98 0 66 -55 534 915 60 123 232 478 383 787 236 486 501 1029 916 1883 329 676 341 1315 35 1930 -381 769 -1224 1240 -2061 1153z m570 -308 c860 -209 1429 -914 1429 -1770 0 -391 -37 -504 -443 -1335 -736 -1510 -1327 -2733 -1337 -2764 -14 -43 -34 -43 -48 0 -5 18 -132 283 -280 588 -148 306 -319 657 -379 781 -59 123 -306 630 -547 1125 -241 495 -458 957 -482 1026 -325 945 210 2001 1165 2300 104 33 158 46 337 77 81 15 491 -5 585 -28z"/><path d="M4343 6944 c-967 -147 -1383 -1299 -724 -2003 774 -827 2140 -241 2077 891 -37 676 -691 1213 -1353 1112z m358 -291 c414 -88 718 -468 718 -900 2 -819 -986 -1230 -1566 -652 -652 649 -54 1743 848 1552z"/></g></svg>`;
  lojasVisiveis.forEach(l=>{const lat=l.latitude,lng=l.longitude;if(!lat||!lng)return;const icon=L.divIcon({html:_svgPin,iconSize:[36,36],iconAnchor:[18,36],className:''});lojaMarkers[l.id]=L.marker([lat,lng],{icon}).addTo(map).bindPopup(`<b>${l.nome}</b><br>${l.endereco||'—'}`);});
