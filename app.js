...
function atualizarMarcadores(){
  ...
  const motoboysFiltrados=_estadoMotoboys===2?[]:_estadoMotoboys===1?allMotoboys.filter(e=>e.disponivel&&!_pedidosAtivosGlobal.some(p=>(p.motoboy_id===e.id||p.entregador_id===e.id)&&_statusAtivos.includes(p.status_detalhado||p.status))):allMotoboys;
