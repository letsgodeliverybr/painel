        ...
        <div class="pd-detail">
          ...
          <div style="margin-top:8px;background:none;border:1px solid #3A3D4A;border-radius:8px;padding:10px">
            ...
            <div style="display:flex;align-items:center;gap:8px">
              <button onclick="event.stopPropagation();alterarPontos('${p.id}',-1)" style="background:none;border:1px solid #3A3D4A;color:#475569;width:30px;height:30px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:700">−</button>
...
function atualizarMarcadores(){
  ...
  const _svgPin=`<svg width="32" height="32" viewBox="0 0 1137 980" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,980) scale(0.1,-0.1)" fill="#1A56DB" stroke="none"><path d="M5400 7881 c-186 -34 -413 -146 -558 -274 -108 -96 -246 -251 -263 -294 -4 -12 -13 -23 -19 -23 -5 0 -10 -5 -10 -10 0 -6 -11 -29 -25 -51 -67 -105 -185 -367 -185 -409 0 -10 -4 -21 -9 -24 -5 -4 -14 -28 -21 -54 -6 -26 -26 -105 -44 -177 -32 -128 -33 -129 -37 -80 -13 137 47 428 121 591 128 283 241 431 484 639 47 40 65 71 24 41 -13 -9 -34 -21 -48 -27 -13 -6 -27 -13 -30 -17 -7 -10 -98 -82 -103 -82 -6 0 -138 -135 -159 -163 -10 -12 -36 -47 -59 -77 -56 -72 -88 -102 -105 -96 -7 3 -16 -4 -19 -15 -5 -16 -16 -19 -65 -19 -58 0 -110 -15 -110 -32 0 -4 -15 -8 -33 -8 -18 0 -52 -9 -75 -20 -22 -11 -46 -20 -52 -20 -6 0 -8 -4 -5 -10 3 -5 -1 -10 -9 -10 -9 0 -16 -4 -16 -10 0 -18 -48 -11 -52 7 -3 14 -8 12 -32 -10 -16 -15 -34 -26 -40 -24 -6 2 -18 -10 -26 -27 -8 -17 -22 -31 -30 -31 -10 0 -16 -12 -18 -33 -2 -24 -8 -32 -20 -30 -13 2 -16 -3 -14 -21 2 -14 0 -21 -7 -17 -7 4 -8 1 -5 -8 3 -9 1 -16 -5 -16 -6 0 -8 -7 -4 -17 4 -10 2 -14 -4 -10 -5 3 -20 -13 -32 -36 -12 -23 -15 -33 -7 -23 25 31 19 8 -8 -27 -37 -51 -91 -234 -128 -437 -19 -108 -22 -159 -22 -375 0 -150 5 -282 13 -330 44 -280 132 -558 257 -807 74 -149 269 -511 359 -668 40 -69 94 -165 120 -215 60 -111 259 -464 410 -725 62 -107 215 -375 341 -595 125 -220 255 -447 289 -505 35 -58 99 -168 144 -246 45 -77 97 -156 117 -175 34 -33 38 -34 112 -33 43 0 142 14 227 32 83 17 209 40 280 52 72 12 148 31 171 41 64 30 71 47 188 449 283 977 348 1201 360 1240 8 25 29 99 46 165 18 66 40 147 51 180 10 33 35 119 54 190 174 626 196 711 190 734 -4 20 -3 22 5 11 8 -13 10 -12 11 5 1 19 3 28 9 50 6 24 7 32 9 75 2 33 4 40 10 25 7 -17 8 -17 13 8 3 15 1 27 -3 27 -5 0 -9 7 -9 16 0 8 5 12 10 9 6 -4 10 7 10 25 0 17 4 29 8 26 5 -3 7 9 4 27 -3 25 -1 29 8 17 8 -12 9 -8 4 14 -5 22 -4 27 6 21 9 -5 11 -4 6 4 -4 6 -3 17 2 24 9 12 27 121 23 144 -1 6 3 14 8 17 5 3 7 25 5 49 -3 31 -2 37 5 22 8 -17 10 -14 10 17 1 20 -3 40 -9 43 -5 3 -10 14 -9 23 0 14 2 13 10 -3 6 -14 7 -7 3 24 -4 30 -3 41 5 37 7 -5 9 -1 5 8 -3 9 -10 16 -15 16 -5 0 -7 46 -3 108 3 59 6 112 6 117 0 6 -3 26 -7 45 -5 27 -4 32 5 20 9 -12 10 -11 5 7 -3 13 -7 52 -8 88 -1 39 -5 58 -9 47 -5 -9 -6 19 -4 63 4 97 -11 188 -30 181 -9 -3 -15 9 -20 40 -6 43 -18 57 -27 32 -2 -7 -4 -2 -4 12 1 14 -2 43 -6 65 -5 24 -4 35 1 27 8 -11 10 -11 15 1 4 10 -1 14 -15 13 -17 -1 -25 10 -40 54 -18 53 -46 115 -95 213 -13 26 -21 47 -16 47 4 0 4 4 -2 8 -5 4 -19 25 -30 46 -40 79 -54 102 -99 171 -25 39 -46 75 -46 82 0 6 -3 13 -7 15 -12 5 -53 66 -53 77 0 5 -8 16 -18 23 -9 7 -30 31 -46 53 -60 80 -217 237 -301 301 -27 21 -52 41 -55 44 -3 4 -61 41 -130 82 -170 102 -343 172 -505 203 -90 18 -377 28 -445 16z"/><path d="M5080 5581 c0 -6 4 -13 10 -16 6 -3 7 1 4 9 -7 18 -14 21 -14 7z"/><path d="M5210 5350 c11 -16 26 -33 32 -36 7 -4 -1 9 -16 29 -34 44 -46 50 -16 7z"/><path d="M5265 5280 c10 -11 20 -20 23 -20 3 0 -3 9 -13 20 -10 11 -20 20 -23 20 -3 0 3 -9 13 -20z"/><path d="M5320 5220 c0 -10 134 -126 165 -142 25 -13 15 -4 -55 52 -30 25 -67 57 -82 72 -16 15 -28 24 -28 18z"/><path d="M7332 6330 c0 -14 2 -19 5 -12 2 6 2 18 0 25 -3 6 -5 1 -5 -13z"/><path d="M7382 6090 c0 -14 2 -19 5 -12 2 6 2 18 0 25 -3 6 -5 1 -5 -13z"/></g></svg>`;
  lojasVisiveis.forEach(l=>{const lat=l.latitude,lng=l.longitude;if(!lat||!lng)return;const icon=L.divIcon({html:_svgPin,iconSize:[32,32],iconAnchor:[16,32],className:''});lojaMarkers[l.id]=L.marker([lat,lng],{icon}).addTo(map).bindPopup(`<b>🏪 ${l.nome}</b><br>${l.endereco||'—'}`);});
  const _statusAtivos=['aceito','chegou_local','chegou_destino','em_rota'];
  const motoboysFiltrados=_filtroMotoboyAtivo?allMotoboys.filter(e=>!allPedidos.some(p=>(p.motoboy_id===e.id||p.entregador_id===e.id)&&_statusAtivos.includes(p.status_detalhado||p.status))):allMotoboys;
  motoboysFiltrados.forEach(e=>{const lat=e.lat||e.latitude,lng=e.lng||e.longitude;if(!lat||!lng)return;const temAtivo=allPedidos.some(p=>(p.motoboy_id===e.id||p.entregador_id===e.id)&&_statusAtivos.includes(p.status_detalhado||p.status));const cor=temAtivo?'#EF4444':e.disponivel?'#10B981':'#475569';const corViseira=temAtivo?'#991b1b':e.disponivel?'#065f46':'#1f2937';const nome=(e.nome||'').split(' ')[0]||'Moto';const svgHelmet=`<svg width="36" height="36" viewBox="0 0 248 243" xmlns="http://www.w3.org/2000/svg"><circle cx="124" cy="121" r="118" fill="none" stroke="white" stroke-width="2"/><g transform="translate(0,243) scale(0.1,-0.1)" stroke="none"><path fill="${cor}" d="M1375 2020 c322 -78 591 -300 702 -578 19 -48 41 -100 48 -117 22 -51 62 -195 85 -305 12 -58 35 -153 51 -213 46 -167 46 -175 0 -316 -49 -147 -105 -251 -183 -334 l-57 -61 -113 38 c-62 21 -189 67 -283 101 -149 55 -254 88 -440 140 -27 8 -97 24 -155 35 -58 11 -135 27 -172 35 -36 8 -139 18 -227 23 -175 9 -193 15 -205 73 -5 28 -33 86 -133 280 -146 281 -162 550 -48 788 25 51 55 106 66 123 19 26 20 33 9 71 -24 86 -24 84 7 90 15 2 117 28 226 56 327 84 428 101 592 97 100 -3 166 -10 230 -26z"/><path fill="${corViseira}" d="M836 1426 c-150 -65 -39 -337 188 -460 353 -192 863 -329 1121 -301 l67 7 -7 36 c-27 154 -119 530 -133 544 -4 4 -70 12 -147 18 -267 20 -557 62 -711 101 -43 11 -105 27 -137 35 -86 22 -212 32 -241 20z"/></g></svg>`;const icon=L.divIcon({html:`<div style="display:flex;flex-direction:column;align-items:center">${svgHelmet}<div style="background:${cor};color:white;font-size:10px;font-weight:700;padding:2px 5px;border-radius:4px;margin-top:2px;white-space:nowrap;box-shadow:0 1px 4px rgba(0,0,0,.4)">${nome}</div></div>`,iconSize:[50,48],iconAnchor:[25,48],className:''});const _statusTxt=temAtivo?'🔴 Ocupado':e.disponivel?'🟢 Disponível':'⚫ Offline';const _tel=e.telefone||e.phone||e.celular||'—';const _ped=allPedidos.filter(p=>(p.motoboy_id===e.id||p.entregador_id===e.id)&&!['finalizado','cancelado'].includes(p.status_detalhado||p.status));const _pedHtml=_ped.length?_ped.map(p=>{const _lj=allLojas.find(l=>l.id===p.loja_id);return`<div style="margin-top:3px;padding:3px 6px;background:#f0f4ff;border-radius:4px;font-size:11px"><b>#${p.numero||p.id?.substring(0,6)}</b> · ${STATUS_LABEL[p.status_detalhado||p.status]||p.status} · ${_lj?.nome||'—'}</div>`;}).join(''):'<div style="font-size:11px;color:#94a3b8">Nenhum pedido ativo</div>';const _popupHtml=`<div style="font-family:Inter,sans-serif;min-width:170px"><div style="font-weight:700;font-size:13px;color:#0f172a;margin-bottom:3px">${e.nome||'Motoboy'}</div>${e.email?`<div style="font-size:11px;color:#64748b;margin-bottom:3px">${e.email}</div>`:''}<div style="font-size:11px;margin-bottom:2px">${_statusTxt}</div><div style="font-size:11px;color:#475569;margin-bottom:5px">📞 ${_tel}</div><div style="font-size:10px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.5px;border-top:1px solid #e2e8f0;padding-top:4px;margin-bottom:3px">Pedidos ativos</div>${_pedHtml}</div>`;motoboyMarkers[e.id]=L.marker([lat,lng],{icon}).addTo(map).bindPopup(_popupHtml,{maxWidth:220});});
