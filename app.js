...
<div style="margin-top:6px;padding-top:6px;border-top:1px solid #e5e7eb">${_motoboyPopup?`<div style="font-size:12px;font-weight:700;color:#111827">🛵 ${_motoboyPopup.nome||'—'}</div>${_motoboyPopup.telefone?`<div style="font-size:11px;margin-top:2px">📞 <a href="https://wa.me/55${_motoboyPopup.telefone.replace(/\D/g,'')}" target="_blank" style="color:#25D366;font-weight:600;text-decoration:none">${_motoboyPopup.telefone}</a></div>`:''}`:`<div style="font-size:11px;color:#f59e0b;font-weight:700">⏳ Aguardando aceite</div>`}</div>`);
